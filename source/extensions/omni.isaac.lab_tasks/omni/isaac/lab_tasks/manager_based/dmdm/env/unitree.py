...
UNITREE_GO2_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        ...
        #usd_path="/home/astrayrmors/Engineering/SLURM_Lab/Dynamic_Mobile_Deformable_Manipulation_DMDM/Code/Isaac-Sim/env/go2.usda",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
UNITREE_RODROPEGO2_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
      # Coordinate with Wenhao's code path
        #usd_path=f"{ISAACLAB_NUCLEUS_DIR}/Robots/Unitree/Go2/go2.usd",
        #usd_path="/home/astrayrmors/Engineering/SLURM_Lab/Dynamic_Mobile_Deformable_Manipulation_DMDM/Code/Isaac-Sim/env/Go2.usda",
        usd_path="/home/hanyang/Dependecies/IsaacLab/source/extensions/omni.isaac.lab_tasks/omni/isaac/lab_tasks/manager_based/dmdm/env/Models/RodRopeGO2_wocolliders_cylinder-r.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.2),
        joint_pos={
            # The prior default positions, Hanyang and Wenhao changed on Nev.15th.
            ".*L_hip_joint": 0.1,
            ".*R_hip_joint": -0.1,
            "F[L,R]_thigh_joint": 0.8,
            "R[L,R]_thigh_joint": 1.0,
            ".*_calf_joint": -1.5,
            # "RevoluteJoint_position": 0.0
            # ".*L_hip_joint": 0.02,
            # ".*R_hip_joint": -0.02,
            # "F[L,R]_thigh_joint": 1.3,
            # "R[L,R]_thigh_joint": 1.32,
            # ".*_calf_joint": -2.73,
            "rod_motor_position": 1.0,
            "base_motor_velocity": 0.0
        },
        joint_vel={".*": 0.0},
    ),
    soft_joint_pos_limit_factor=0.9,
    actuators={
        "base_legs": DCMotorCfg(
            joint_names_expr=['FL_hip_joint', 'FR_hip_joint', 'RL_hip_joint', 'RR_hip_joint', 'FL_thigh_joint', 'FR_thigh_joint', 'RL_thigh_joint', 'RR_thigh_joint'],
            effort_limit=23.7,
        ...
        "calf_joints": DCMotorCfg(
            ...
            effort_limit=23.7,    # 45.43
            saturation_effort=23.7,   #45.43
            velocity_limit=30.0,
            stiffness=25.0,
            damping=0.5,
            friction=0.0,
        ),
        "rod_motor": DCMotorCfg(
            joint_names_expr=["rod_motor_position", "base_motor_velocity"],
            effort_limit=3.2,        #3.2
            saturation_effort=3.1,  #3.1
            velocity_limit=3.0,
            stiffness=200.0, # 200
            damping=6, # 5
            friction=0.00,
